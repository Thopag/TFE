...
function add_lido_shift_inhib_traj(plt)
    ...
    plot!(plt, 1.0 .- remaining_1_8, lido_shifts_inact_1_8 .+ lido_shifts_act_1_8, color=:cyan, label="", linewidth = 3)
    ...
    scatter!(plt, 1.0 .- remaining_1_8, lido_shifts_inact_1_8 .+ lido_shifts_act_1_8, color=:cyan, markersize=4, label="", markerstrokewidth = 0.0)
