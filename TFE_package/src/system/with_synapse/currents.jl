...
function INMDA(V, A_NMDA, B_NMDA, g_NMDA, E_NMDA; shift::Float64=0.0, with_shift::Bool=false)
    I = (B_NMDA-A_NMDA) * g_NMDA *NMDA_Mg_block(V; shift=shift, with_shift=with_shift)*(V-E_NMDA)   # [µA/cm^2]
    return I
end
