...
function alpha_m3(V::Float64; lido_shift::Float64=0)
    jp = 4.2
    return 10.22/(1+exp((V-(-7.19-jp-12+lido_shift))/-15.43))
end

function alpha_h3(V::Float64; lido_shift::Float64=0)
    jp = 4.2
    return 0.0744/(1+exp((V-(-99.76-jp+10+lido_shift))/11.07))
end

function beta_m3(V::Float64; lido_shift::Float64=0)
    jp = 4.2
    return 23.76/(1+exp((V-(-70.37-jp-12+lido_shift))/14.53))
end

function beta_h3(V::Float64; lido_shift::Float64=0)
    jp = 4.2
...
function h3_inf(V::Float64; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
    # Lidocaine effect
...
function dot_m3(V::Float64, m3::Float64; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
    x_inf = m3_inf(V; C_lido=C_lido, shift=shift, with_shift=with_shift, linear_shift_mode=linear_shift_mode)
    tau_x = tau_m3(V)
    return (x_inf-m3)/tau_x
end

function dot_h3(V::Float64, h3::Float64; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
