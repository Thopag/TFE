...
function h3_inf(V; C_lido=0.0, shift=0.0, with_shift=false, linear_shift_mode=false)
    # Lidocaine effect
...
function m3_inf(V; C_lido=0.0, shift=0.0, with_shift=false, linear_shift_mode=false)
    # Lidocaine effect
    lido_shift = m3_shift()
...
function dot_m3(V, m3; C_lido=0.0, shift=0.0, with_shift=false, linear_shift_mode=false)
    x_inf = m3_inf(V; C_lido=C_lido, shift=shift, with_shift=with_shift, linear_shift_mode=linear_shift_mode)
    tau_x = tau_m3(V)
    return (x_inf-m3)/tau_x
end

function dot_h3(V, h3; C_lido=0.0, shift=0.0, with_shift=false, linear_shift_mode=false)
