...
function alpha_m7(V; lido_shift::Float64=0)
    jp = 4.2
    return 10.22/(1+exp((V-(-7.19-jp+lido_shift))/-15.43))
end

function alpha_h7(V; lido_shift::Float64=0)
    jp = 4.2
    return 0.0744/(1+exp((V-(-99.76-jp+lido_shift))/11.07))
end

function beta_m7(V; lido_shift::Float64=0)
    jp = 4.2
    return 23.76/(1+exp((V-(-70.37-jp+lido_shift))/14.53))
end

function beta_h7(V; lido_shift::Float64=0)
    jp = 4.2
...
function h7_inf(V; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
    # Lidocaine effect
...
function m7_inf(V; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
    # Lidocaine effect
    lido_shift = m7_shift()
...
function dot_m7(V, m7; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
    x_inf = m7_inf(V; C_lido=C_lido, shift=shift, with_shift=with_shift, linear_shift_mode=linear_shift_mode)
    tau_x = tau_m7(V)
    return (x_inf-m7)/tau_x
end

function dot_h7(V, h7; C_lido::Float64=0.0, shift::Float64=0.0, with_shift::Bool=false, linear_shift_mode::Bool=false)
