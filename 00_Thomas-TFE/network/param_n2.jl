...
include("gates.jl")
    ...
    p_glob_n2 = (I_s_n2,k,F,L,D)
    p_fixed_n2 = (C,eNa,eK,eCa,eleak,Ca_o,Ca_i_0,tau_Ca,d,Ra)
    ...
    p_syn_fixed_n2 = (eNMDA,eAMPA,U1_NMDA,tau_rise_NMDA,tau_decay_NMDA,tau_fac_NMDA,tau_rec_NMDA,U1_AMPA,tau_rise_AMPA,tau_decay_AMPA,tau_fac_AMPA,tau_rec_AMPA,ratio_ICa_of_INMDA)

    gNMDA = 1 #mS/cm²  #1
    gAMPA = 1 #mS/cm²  #1
    gGRPR = 0 #mS/cm²  #5
    p_syn_var_n2 = (gNMDA,gAMPA)
