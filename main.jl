...
function main_default()
    ...
    counts = window_count(t_spikes, stim_on, stim_off; window_width=100)
    ...
    plt_all = plot_all(t, V, m3, h3, m7, h7, m8, h8, ndr, ldr, nm, z_AHP, amp,
                            I_NaV1p3, I_NaV1p7, I_NaV1p8, I_Kdr, I_Km, I_AHP, I_Leak, I_ext
                                ; xlimits=xlimits)
    display(plt_all)
